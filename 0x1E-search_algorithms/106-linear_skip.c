...
/**
 * _get_max_id - gets the maximum index of a skip list's
 * + bucket; that is the far-right index.
 *
 * @right: pointer to current express node
 *
 * Return: index of right-most element in bucket
 */
